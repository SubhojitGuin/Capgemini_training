...
//        employees.add(null); Gives NullPointerException as it tries to call the compareTo() method;
        employees.add(new Employee(7, "Elena", "male", LocalDate.of(1990, Month.SEPTEMBER, 9), 4, "eleni@example.com", 9456789012L)); // Since it is comparing using id, as it is same the object won't be added or overwritten.
